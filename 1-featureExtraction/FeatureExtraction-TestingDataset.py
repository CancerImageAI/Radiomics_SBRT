# -*- coding: utf-8 -*-
"""
Created on Tue Jun 29 16:05:43 2021
...
if __name__ == '__main__':
    ...
    data = xlrd.open_workbook('../data_list/TestingDataset.xls')
    table = data.sheets()[0]
    List_all = table.col_values(11)[1:]
    Class = np.array(table.col_values(-6)[1:])
    Img_Path = '../data_list/TestingDataset/Image'
    Mask_Path = '../data_list/TestingDataset/Mask'
    ...
    df.to_csv('../Results/TestingData_Radiomics_Feature.csv', index = False, sep=',')
